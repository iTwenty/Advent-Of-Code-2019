...
//  Advent Of Code 2019
//
//  Created by jaydeep on 05/12/19.
...
struct Puzzle05: Puzzle {
    ...
    private func processInstruction(_ instruction: Int, input: inout [Int], pc: inout Int) {
        ...
        case 1, 2:
            ...
            input[thdParam] = ((opcode == 1) ? fstValue + sndValue : fstValue * sndValue)
            pc = pc + 4
        case 3:
            input[input[pc + 1]] = 1
            pc = pc + 2
    ...
    func part1() -> String {
        ...
        while pc < inputt.count {
            ...
            processInstruction(instruction, input: &inputt, pc: &pc)
        }
        return ""
    }
